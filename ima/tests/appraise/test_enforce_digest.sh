...
# Description: test_enforce_digest
# Author: Zhang Tianxing <zhangtianxing3@huawei.com>
# Create: 2020/09/08

TST_TESTFUNC=test_enforce_digest
TST_SETUP=setup

export TCID=test_enforce_digest
